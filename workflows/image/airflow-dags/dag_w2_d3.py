...
def dag_w2_d3():
    ...
    def func_1_4(
        ...
        if enable_optimization:
            ...
            # 并行执行任务
            sleep_time_ms_1, sleep_time_ms_2, _ = execute_parallel_tasks(tasks)
            
            sleep_time_ms = max(sleep_time_ms_1, sleep_time_ms_2)

            logging.info(f"WHC IMP IMP IMP: sleep_time_ms: {sleep_time_ms} sleep_time_ms_1: {sleep_time_ms_1} sleep_time_ms_2: {sleep_time_ms_2}")
    ...
    func_1_2_output = func_1_2(sleep_time_ms = func_1_1_output, fixed_sleep_seconds=(sleep_time_ms / 1000) /2, dynamic_ratio=0.5, dag_id='dag_w2_d3', upstream_task_id='func_1_1', task_name='func_1_2', enable_optimization=_enable_optimization)
    
    func_1_3_output = func_1_3(sleep_time_ms = func_1_1_output, fixed_sleep_seconds=(sleep_time_ms / 1000) /2, dynamic_ratio=0.5, dag_id='dag_w2_d3', upstream_task_id='func_1_1', task_name='func_1_3', enable_optimization=_enable_optimization)
    
    func_1_4_output = func_1_4(sleep_time_ms_1 = func_1_2_output, sleep_time_ms_2 = func_1_3_output, fixed_sleep_seconds=(sleep_time_ms / 1000) /2, dynamic_ratio=0.5, dag_id='dag_w2_d3', upstream_task_id='func_1_3', task_name='func_1_4', enable_optimization=_enable_optimization)
