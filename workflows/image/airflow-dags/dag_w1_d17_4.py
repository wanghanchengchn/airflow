...
####
# 这是ExCamera的函数，运行方法是：./scripts/8_get_e2e_breakdown.sh 1 "dag_w1_d17_4" 160 16
        ...
        try:
            ...
            if upstream_task:
                ...
                if value is not None:
                    logging.info(f"WHC: Attempt and then get upstream value: {value}")
                    return value
