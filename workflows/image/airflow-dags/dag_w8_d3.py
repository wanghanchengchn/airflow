...
def dag_w8_d3():
    ...
    def func_1_10(
        ...
        if enable_optimization:
            ...
            # 并行执行任务
            sleep_time_ms_1, sleep_time_ms_2, sleep_time_ms_3, sleep_time_ms_4, sleep_time_ms_5, sleep_time_ms_6, sleep_time_ms_7, sleep_time_ms_8, _ = execute_parallel_tasks(tasks)

            sleep_time_ms = max(sleep_time_ms_1, sleep_time_ms_2, sleep_time_ms_3, sleep_time_ms_4, sleep_time_ms_5, sleep_time_ms_6, sleep_time_ms_7, sleep_time_ms_8)

            logging.info(f"WHC IMP IMP IMP: sleep_time_ms: {sleep_time_ms} sleep_time_ms_1: {sleep_time_ms_1} sleep_time_ms_2: {sleep_time_ms_2} sleep_time_ms_3: {sleep_time_ms_3} sleep_time_ms_4: {sleep_time_ms_4} sleep_time_ms_5: {sleep_time_ms_5} sleep_time_ms_6: {sleep_time_ms_6} sleep_time_ms_7: {sleep_time_ms_7} sleep_time_ms_8: {sleep_time_ms_8}")
    ...
    func_1_2_output = func_1_2(sleep_time_ms = func_1_1_output, fixed_sleep_seconds=(sleep_time_ms / 1000) /2, dynamic_ratio=0.5, dag_id='dag_w8_d3', upstream_task_id='func_1_1', task_name='func_1_2', enable_optimization=_enable_optimization)
    
    func_1_3_output = func_1_3(sleep_time_ms = func_1_1_output, fixed_sleep_seconds=(sleep_time_ms / 1000) /2, dynamic_ratio=0.5, dag_id='dag_w8_d3', upstream_task_id='func_1_1', task_name='func_1_3', enable_optimization=_enable_optimization)
    
    func_1_4_output = func_1_4(sleep_time_ms = func_1_1_output, fixed_sleep_seconds=(sleep_time_ms / 1000) /2, dynamic_ratio=0.5, dag_id='dag_w8_d3', upstream_task_id='func_1_1', task_name='func_1_4', enable_optimization=_enable_optimization)

    func_1_5_output = func_1_5(sleep_time_ms = func_1_1_output, fixed_sleep_seconds=(sleep_time_ms / 1000) /2, dynamic_ratio=0.5, dag_id='dag_w8_d3', upstream_task_id='func_1_1', task_name='func_1_5', enable_optimization=_enable_optimization)
    
    func_1_6_output = func_1_6(sleep_time_ms = func_1_1_output, fixed_sleep_seconds=(sleep_time_ms / 1000) /2, dynamic_ratio=0.5, dag_id='dag_w8_d3', upstream_task_id='func_1_1', task_name='func_1_6', enable_optimization=_enable_optimization)

    func_1_7_output = func_1_7(sleep_time_ms = func_1_1_output, fixed_sleep_seconds=(sleep_time_ms / 1000) /2, dynamic_ratio=0.5, dag_id='dag_w8_d3', upstream_task_id='func_1_1', task_name='func_1_7', enable_optimization=_enable_optimization)

    func_1_8_output = func_1_8(sleep_time_ms = func_1_1_output, fixed_sleep_seconds=(sleep_time_ms / 1000) /2, dynamic_ratio=0.5, dag_id='dag_w8_d3', upstream_task_id='func_1_1', task_name='func_1_8', enable_optimization=_enable_optimization)

    func_1_9_output = func_1_9(sleep_time_ms = func_1_1_output, fixed_sleep_seconds=(sleep_time_ms / 1000) /2, dynamic_ratio=0.5, dag_id='dag_w8_d3', upstream_task_id='func_1_1', task_name='func_1_9', enable_optimization=_enable_optimization)

    func_1_10_output = func_1_10(sleep_time_ms_1 = func_1_2_output, sleep_time_ms_2 = func_1_3_output, sleep_time_ms_3 = func_1_4_output, sleep_time_ms_4 = func_1_5_output, sleep_time_ms_5 = func_1_6_output, sleep_time_ms_6 = func_1_7_output, sleep_time_ms_7 = func_1_8_output, sleep_time_ms_8 = func_1_9_output, fixed_sleep_seconds=(sleep_time_ms / 1000) /2, dynamic_ratio=0.5, dag_id='dag_w8_d3', upstream_task_id='func_1_9', task_name='func_1_10', enable_optimization=_enable_optimization)
